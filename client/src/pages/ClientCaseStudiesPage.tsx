...
export default function ClientCaseStudiesPage() {
  ...
  const caseStudies = [
    ...
    {
      company: 'A Oncology Biopharma Company', // Generic name for Wembrace/Client
      industry: 'Biopharma',
      challenge:
  ...
  const testimonials = [
    {
      // Connected to: IMARC / Market Research Automation
      quote:
    ...
    {
      // Connected to: RV Solutions / Invoice Automation
      quote:
    ...
    {
      // Connected to: Wembrace / Biopharma Ops Portal
      quote:
        ...
        <div className="container-padding">
          ...
          <div className="space-y-16">
            {caseStudies.map((study, index) => (
              <Card key={index} className="overflow-hidden border-2 border-border/50 hover:border-accent/50 transition-all duration-300">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-padding">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-primary">What Our Clients Say</h2>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-none bg-background hover:shadow-lg transition-shadow">
